	...
	jQuery('.patterns a').click(function(e) {
		e.preventDefault();
			...
			var name = jQuery(this).attr('name');
				jQuery('body').css('background', 'url(lib/themes/switch/images/pattern/'+name+'.png) repeat center center scroll');
...
// Style Selector function ////////////////////////////////////
	jQuery('.style a').click(function(e) {
		...
		if(name == 'green') {
			...
			jQuery('#callCss').attr('href', 'lib/themes/'+name+'/bootstrap.min.css');
		}
